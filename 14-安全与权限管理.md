> **📖 OpenClaw 中文实战教程** | [← 上一章：教程自动更新与仓库维护](13-教程自动更新与仓库维护.md) | [目录](README.md) | [下一章：Memory 记忆系统深入 →](15-Memory 记忆系统深入.md)

---

---
[⬅️ 上一章：教程自动更新与仓库维护](13-教程自动更新与仓库维护.md) | [📑 目录](README.md) | [➡️ 下一章：Memory 记忆系统深入](15-Memory 记忆系统深入.md)
---
...
OpenClaw uses role-based access control (RBAC) for managing permissions. It supports multi-user authentication and secure access management. Security configurations are critical to prevent risks.

### 补充 2

- **Security - OpenClaw Docs** (relevance: 73%)
  https://docs.openclaw.ai/gateway/security
  *   [Control plane tools risk](https://docs.openclaw.ai/gateway/security#control-plane-tools-risk). *   [DM access model (pairing / allowlist / open / disabled)](https://docs.openclaw.ai/gateway/security#dm

### 补充 3

- **So, you want to run OpenClaw? - Thoughtworks - Medium** (relevance: 66%)
  https://thoughtworks.medium.com/so-you-want-to-run-openclaw-63ea53d17342
  Permission-hungry agents and the… | by Thoughtworks | Mar, 2026 | Medium. [Open in app](https://play.google.com/store/apps/details?id=com.medium.r

### 补充 4

- **Running OpenClaw with root access: a security risk - LinkedIn** (relevance: 54%)
  https://www.linkedin.com/posts/jamesamalone_i-am-shocked-people-run-openclaw-with-access-activity-7432932255955836929-XpTp
  Running OpenClaw with such access and permissions is indeed a considerable risk. Ensurin

### 补充 5

- **OpenClaw security: architecture and hardening guide - Nebius** (relevance: 54%)
  https://nebius.com/blog/posts/openc
...
> **📖 章节导航** | [← 上一章：教程自动更新与仓库维护](13-教程自动更新与仓库维护.md) | [目录](README.md) | [下一章：Memory 记忆系统深入 →](15-Memory 记忆系统深入.md)
