> **📖 OpenClaw 中文实战教程** | [← 上一章：持续集成与知识库同步](10-持续集成与知识库同步.md) | [目录](README.md) | [下一章：实践案例与常见问题 →](12-实践案例与常见问题.md)
...
OpenClaw integrates third-party APIs via skills and plugins, supports OpenRouter for model routing, and offers over 50 app and service integrations.

### 补充 2

- **OpenClaw custom API integration guide for skills and plugins** (relevance: 74%)
  https://lumadock.com/tutorials/openclaw-custom-api-integration-guide
  # OpenClaw custom API integration guide for skills and plugins. OpenClaw custom API integration guide for skills and plugins - OpenClaw custom

### 补充 3

- **Integration with OpenClaw | OpenRouter | Documentation** (relevance: 67%)
  https://openrouter.ai/docs/guides/guides/coding-agents/openclaw-integration
  Use OpenClaw (formerly Moltbot, formerly Clawdbot) with OpenRouter. The easiest way to configure OpenClaw with OpenRouter is using the built-i

### 补充 4

- **Integrating Openclaw with Generative APIs | Scaleway Documentation** (relevance: 66%)
  https://www.scaleway.com/en/docs/generative-apis/reference-content/integrate-with-openclaw/
  ## Configure Openclaw. Configure Openclaw to use Scaleway's Generative APIs:. {  "models":  {  "mode":  "merge",

### 补充 5

- **Integrations - OpenClaw** (relevance: 66%)
  https://openclaw.ai/integrations
  50+ integrations with the apps and services you already use. Chat from your phone, control from your desktop, automate everything. ## ⟩ Chat Providers. Message OpenClaw from any chat app — it responds right where you
...
> **📖 章节导航** | [← 上一章：持续集成与知识库同步](10-持续集成与知识库同步.md) | [目录](README.md) | [下一章：实践案例与常见问题 →](12-实践案例与常见问题.md)
